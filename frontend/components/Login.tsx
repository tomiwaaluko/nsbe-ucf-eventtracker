...
export function Login({ onLogin, onNavigate, isLoading = false }: LoginProps) {
  ...
  return (
    <div
      className={`${bricolage.variable} ${sora.variable} min-h-screen relative font-sans`}
              ...
              <div className="space-y-3">
                ...
                >
                  <button
                    ...
                    disabled
                    style={{ fontFamily: "var(--font-bricolage)" }}
                    className={`w-full bg-white text-black/40 py-4 font-bold text-base uppercase tracking-wider border-4 border-black/30 shadow-[6px_6px_0_0_rgba(0,0,0,0.2)] transition-all duration-200 cursor-not-allowed flex items-center justify-center gap-3 relative overflow-hidden`}
                  >
                  ...
                  <div className="absolute -top-2 -right-2 z-10">
                    <div className="flex items-center gap-1 px-2 py-1 bg-amber-100 border-2 border-amber-600 shadow-[2px_2px_0_0_rgba(0,0,0,1)]">
                      <Construction className="w-3 h-3 text-amber-700" />
                ...
                >
                  <button
                    ...
                    disabled
                    style={{ fontFamily: "var(--font-bricolage)" }}
                    className={`w-full bg-[#5865F2] text-white/40 py-4 font-bold text-base uppercase tracking-wider border-4 border-black/30 shadow-[6px_6px_0_0_rgba(0,0,0,0.2)] transition-all duration-200 cursor-not-allowed flex items-center justify-center gap-3 relative overflow-hidden`}
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-amber-50 to-transparent opacity-30" />
                    <div className="relative z-10 flex items-center gap-3">
