            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                <Button
                  ...
                  variant="outline"
                  disabled
                  className="w-full h-11 border-gray-300 bg-gray-50 text-gray-400 cursor-not-allowed flex items-center justify-center gap-3 relative overflow-hidden"
                >
                ...
                <div className="absolute -top-2 -right-2 z-10">
                  <div className="flex items-center gap-1 px-2 py-1 bg-amber-100 border border-amber-600 rounded shadow-sm">
