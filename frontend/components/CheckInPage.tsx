  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-4 lg:p-8 space-y-6">
        ...
        {/* Main Check-In Card - Brutalist style */}
        <motion.div
          initial={{ opacity: 0, y: 30, rotate: -1 }}
          animate={{ opacity: 1, y: 0, rotate: 0 }}
          ...
          <div className="relative bg-white border-4 border-black shadow-[8px_8px_0_0_rgba(0,0,0,1)] p-8">
            <div className="max-w-2xl mx-auto space-y-6">
              ...
              <div className="text-center mb-6">
                ...
                >
                  <div className="text-center">
                    <Camera className="w-20 h-20 text-black/60 mx-auto mb-4" />
                    <p
              ...
              <div className="space-y-4">
                <div className="text-center">
                  <div className="inline-flex items-center gap-2 text-black/60 text-sm">
                    <div className="h-px w-12 bg-black/20"></div>
                    <span className={sora.className}>Or enter event code</span>
                    <div className="h-px w-12 bg-black/20"></div>
                  </div>
                </div>
                ...
                <motion.button
                  ...
                  className="w-full bg-[#00a651] text-white py-4 border-4 border-black shadow-[6px_6px_0_0_rgba(0,0,0,1)] font-bold uppercase tracking-wider transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 hover:bg-[#008a44] text-lg"
                >
                  {loading ? (
                    <>
        ...
        {/* Instructions and Tips Cards - Grid layout */}
              ...
              <ul className="space-y-2">
                {[
                  ...
                  >
                    ...
                    <span
                      className={`${sora.className} text-black/80 font-medium text-sm`}
                    >
                      {tip}
                    </span>
                  </motion.li>
