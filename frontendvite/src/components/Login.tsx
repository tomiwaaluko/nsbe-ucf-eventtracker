        ...
        <div>
          ...
          <div className="max-w-md">
            ...
            <p className="text-lg text-white/90 mb-8">
              Track your journey to excellence. Monitor your 1-1-1 and 3-3-3 progress
              and stay connected with the NSBE community.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">Monitor workshops, GBMs, and community service</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">Quick QR code scanning for event attendance</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">Never miss an important NSBE event</p>
                </div>
              </div>
            </div>
          </div>
